...
export default function ({
  ...
  const list = [ `Email: ${JSON.stringify(item.item.email)}`, `Téléphone: ${JSON.stringify(item.item.phone)}`, `dossier Medicale: ${JSON.stringify(item.item.dossier_medicale)}`, `Adresse: ${JSON.stringify(item.item.adresseLocal)}`]
